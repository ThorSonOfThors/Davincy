<template>
  <div class="register-page">
    ...
    <Transition name="slide-fade">
      <div v-if="alert.show" :class="['custom-alert', alert.type]">
      ...
      <div v-if="showModal" class="modal-overlay" @click.self="closeModal">
        <div class="modal-card">
          ...
          <div class="modal-content">
            <p class="modal-text">
              Your registration request has been submitted successfully and is pending approval.
            </p>
            ...
            <p class="modal-note">
              An administrator will review your request within 24-48 hours. You will receive an email confirmation once your account is activated.
            </p>
          </div>
          
          <button class="btn btn-primary modal-btn" @click="closeModal">
    ...
    <div class="container">
      <div class="login-card">
        ...
        <form @submit.prevent="register" class="login-form">
          ...
          >
            <span class="btn-icon">📝</span>
            {{ loading ? "Processing Request..." : "Request Registration" }}
            <span class="btn-icon">→</span>
          </button>
        ...
        <div class="security-notice">
          ...
          <span>All registrations are reviewed by authorized personnel</span>
        </div>
      </div>
    </div>
  </div>
...
const register = async () => {
  ...
  try {
    ...
    const { data, error: signUpError } = await supabase.auth.signUp({
      ...
      options: {
        data: {
          role: 'pending' // Mark as pending approval
        }
      }
    })
    ...
    showAlert('success', 'Registration request submitted successfully')
